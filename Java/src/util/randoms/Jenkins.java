...
public class Jenkins extends Random {
	...
	/**
	 * The lower 16 bits are used to set the next character for the jenkins one-at-a-time hash function,
	 * the middle 32 bits are used for setting the initial value of the hash function. The uppermost 16 bits are ignored.
	 */
	@Override

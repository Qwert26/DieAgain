package com.github.qwert26.dieAgain.util;
import com.github.qwert26.dieAgain.test.*;
public class TestData {
	...
	public ITest getTestMethod() {
		return testMethod;
	}

	public void setTestMethod(ITest testMethod) {
